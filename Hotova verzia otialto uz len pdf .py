...
if __name__ == "__main__":
    try:
        ...
        if not session.query(GlassCategory).first():
            ...
            glasses = [
                # FLOAT
                Glass(name="2mm antireflexné", category=categories["FLOAT"], price_per_m2=12.21, cutting_fee=5.0, min_area=0.1),
                Glass(name="2mm Float", category=categories["FLOAT"], price_per_m2=11.67, cutting_fee=5.0, min_area=0.1),
                Glass(name="3mm Float", category=categories["FLOAT"], price_per_m2=6.02, cutting_fee=5.0, min_area=0.1),
                Glass(name="4mm OPTIWHITE", category=categories["FLOAT"], price_per_m2=12.16, cutting_fee=5.0, min_area=0.1),
                Glass(name="4mm Float", category=categories["FLOAT"], price_per_m2=7.00, cutting_fee=5.0, min_area=0.1),
                Glass(name="5mm Float", category=categories["FLOAT"], price_per_m2=9.34, cutting_fee=5.0, min_area=0.1),
                Glass(name="6mm Float", category=categories["FLOAT"], price_per_m2=10.77, cutting_fee=5.0, min_area=0.1),
                Glass(name="6mm OPTIWHITE", category=categories["FLOAT"], price_per_m2=15.26, cutting_fee=5.0, min_area=0.1),
                Glass(name="8mm Float", category=categories["FLOAT"], price_per_m2=13.88, cutting_fee=5.0, min_area=0.1),
                Glass(name="8mm OPTIWHITE", category=categories["FLOAT"], price_per_m2=28.16, cutting_fee=5.0, min_area=0.1),
                Glass(name="10mm Float", category=categories["FLOAT"], price_per_m2=20.00, cutting_fee=5.0, min_area=0.1),
                Glass(name="10mm OPTIWHITE", category=categories["FLOAT"], price_per_m2=39.85, cutting_fee=5.0, min_area=0.1),
                Glass(name="12mm Float", category=categories["FLOAT"], price_per_m2=50.00, cutting_fee=5.0, min_area=0.1),
                Glass(name="Keramické-krbové sklo", category=categories["FLOAT"], price_per_m2=212.50, cutting_fee=5.0, min_area=0.1),

                # PLANIBEL
                Glass(name="3mm Planibel bronz", category=categories["PLANIBEL"], price_per_m2=6.82, cutting_fee=5.0, min_area=0.1),
                Glass(name="4mm Planibel bronz + šedý", category=categories["PLANIBEL"], price_per_m2=13.78, cutting_fee=5.0, min_area=0.1),
                Glass(name="5mm Planibel bronz", category=categories["PLANIBEL"], price_per_m2=13.14, cutting_fee=5.0, min_area=0.1),
                Glass(name="6mm Planibel bronz + šedý", category=categories["PLANIBEL"], price_per_m2=22.00, cutting_fee=5.0, min_area=0.1),
                Glass(name="8mm Planibel bronz + šedý", category=categories["PLANIBEL"], price_per_m2=33.00, cutting_fee=5.0, min_area=0.1),
